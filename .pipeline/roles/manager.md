...
Единственная роль, управляющая маршрутом задачи. Последовательно организует PLAN, WORK и обязательный VERIFY. REVIEW запускается только по `.pipeline/pipeline.yaml`.
